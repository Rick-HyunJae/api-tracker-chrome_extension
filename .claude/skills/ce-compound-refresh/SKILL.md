...
description: |
  Use when asked to 'refresh learnings', 'audit docs/solutions/', or
  'consolidate overlapping docs' — reviews existing docs against the current
  codebase and updates, consolidates, or deletes drifted ones.
